...
If you have more than one car you charge at home, create two sensors and two automations to control both along with a condition to chec determine which car is plugged in, then only one will run
